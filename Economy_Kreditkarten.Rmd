...
```{r Daten einlesen und allgemeine Aufbereitungen, echo = FALSE}
kredit <- read_xlsx('Aggregierte_Wochenzahlen_SPA-Mitglieder_Zahlungen_mit_inländische Kredit....xlsx',sheet ='Tabelle1', skip=2) %>%
  rename(variable = ...1)%>%
...
kredit_long <- kredit%>%
  ...
  select(date,value,topic,variable_oldname,variable_short,variable_long,location,unit,source,update,public,description)
